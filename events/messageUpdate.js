...
module.exports = async (oldMessage, newMessage) => {
  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      { name: "👤 العضو", value: `${oldMessage.author}`, inline: true },
      { name: "📍 الروم", value: `${oldMessage.channel}`, inline: true },
      { name: "قبل التعديل", value: oldMessage.content.substring(0, 1024) },
      { name: "بعد التعديل", value: newMessage.content.substring(0, 1024) }
    )
    .setTimestamp()
